...
{-1,-1}}
 ...
 POINT WinSizeBorderLarge[4][5]={ {{320+LARGE_BORDER_SIDE*2,200+(BORDER_TOP+LARGE_BORDER_BOTTOM)},
{640+(LARGE_BORDER_SIDE*2)*2,400+2*(BORDER_TOP+LARGE_BORDER_BOTTOM)}, 
{960+(LARGE_BORDER_SIDE*3)*2, 600+3*(BORDER_TOP+LARGE_BORDER_BOTTOM)},
{1280+(LARGE_BORDER_SIDE*4)*2,800+4*(BORDER_TOP+LARGE_BORDER_BOTTOM)},
{-1,-1}},
{{640+(LARGE_BORDER_SIDE*2)*2,200+(BORDER_TOP+LARGE_BORDER_BOTTOM)},
{640+(LARGE_BORDER_SIDE*2)*2,400+2*(BORDER_TOP+LARGE_BORDER_BOTTOM)},
{1280+(LARGE_BORDER_SIDE*4)*2,400+2*(BORDER_TOP+LARGE_BORDER_BOTTOM)},
{1280+(LARGE_BORDER_SIDE*4)*2,800+4*(BORDER_TOP+LARGE_BORDER_BOTTOM)},
{-1,-1}},
{{640+(LARGE_BORDER_SIDE*2)*2,400+2*(BORDER_TOP+LARGE_BORDER_BOTTOM)},
{1280+(LARGE_BORDER_SIDE*4)*2,800+4*(BORDER_TOP+LARGE_BORDER_BOTTOM)},
...
{-1,-1}}
 ...
 POINT WinSizeBorderVeryLarge[4][5]={ {{320+VERY_LARGE_BORDER_SIDE*2,200+(BORDER_TOP+VERY_LARGE_BORDER_BOTTOM)},
